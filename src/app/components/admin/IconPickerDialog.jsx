    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-5xl">
        ...
        <div className="space-y-3">
          ...
          <ScrollArea className="h-[60vh] rounded-md border border-[rgb(var(--renora-accent-rgb)/0.2)] bg-white">
            <div className="p-3">
                ...
                {filtered.map((k) => {
                  ...
                  return (
                    <button
                      ...
                      className={
                        "group flex flex-col items-center justify-center gap-1 rounded-md border bg-card p-2 text-center hover:bg-[rgb(var(--renora-accent-hover-rgb)/0.08)] " +
                        (selected
                          ? "border-[rgb(var(--renora-accent-rgb)/0.6)]"
                          : "border-border")
                      }
                      title={k}
                    >
                      {Icon ? (
                        <Icon
                          className={
                            "h-5 w-5 " +
                            (selected
                              ? "text-[rgb(var(--renora-accent-rgb))]"
                              : "text-foreground")
                          }
                          aria-hidden
                        />
