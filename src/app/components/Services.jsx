      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {servicesToShow.map((service) => {
            ...
            return (
              <Link key={serviceKey} to={servicePath} className="block">
                <Card className="group overflow-hidden border-[var(--card-border)] hover:border-[var(--card-border-hover)] transition-all duration-300 hover:shadow-xl">
